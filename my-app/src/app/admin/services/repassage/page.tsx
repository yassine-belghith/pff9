...
export default function RepassageAdminPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await fetch("http://localhost:5001/api/services?category=repassage", {
  ...
  const handleSubmit = async () => {
    ...
    await fetch("http://localhost:5001/api/admin/services", {
      ...
      body: JSON.stringify({ category: "repassage", ...form, price: Number(form.price) }),
    });
    setModalOpen(false);
